...
def process_args():
    ...
    parser.add_argument('-input_dir', help='Google cloud storage path for input videos samples.',default="gs://api-project-773889352370-testing/SantaLuciaFlowers/Cameras/201401/")
