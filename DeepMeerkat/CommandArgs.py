...
def CommandArgs():
    ...
    parser.add_argument("--size", help="Minimum size of contour",default=0.05,type=float)
    ...
    parser.add_argument("--moglearning", help="Speed of MOG background detector, lowering values are more sensitive to movement",default=0.12,type=float)                                
    parser.add_argument("--mogvariance", help="Variance in MOG to select background",default=30,type=int)                                
